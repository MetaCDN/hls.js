...
class FragmentLoader extends EventHandler {
  ...
  onFragLoading(data) {
    ...
    this.loader.load(frag.url, 'arraybuffer', this.loadsuccess.bind(this), this.loaderror.bind(this), this.loadtimeout.bind(this), config.fragLoadingTimeOut, 1, 0, config.loadingBackOff, null, this.loadprogress.bind(this), frag);
  }
